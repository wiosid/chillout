...
use Rest\Model\PhotoRest;  //  <-- Model imported
...
class PhotosController extends BaseController {
    ...
    public function preDispatch() {
        ...
        $photoRestModel=new PhotoRest($this->getServiceLocator()->get('db'), $this->getOauth());
        $photoRestModel->setPhotoTable($this->getServiceLocator()->get('Models\Model\PhotosTable'));
        $this->setModel($photoRestModel);
        parent::preDispatch();
