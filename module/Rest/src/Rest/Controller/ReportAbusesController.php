...
use Rest\Model\ReportAbuseRest;  //  <-- Model imported

class ReportAbusesController extends BaseController {
    ...
    public function preDispatch() {
        ...
        $reportAbuseRestModel=new ReportAbuseRest($this->getServiceLocator()->get('db'), $this->getOauth());
        $reportAbuseRestModel->setReportAbuseTable($this->getServiceLocator()->get('Models\Model\ReportAbusesTable'));
        $reportAbuseRestModel->setUserTable($this->getServiceLocator()->get('Models\Model\UsersTable'));
        $this->setModel($reportAbuseRestModel);
        parent::preDispatch();
